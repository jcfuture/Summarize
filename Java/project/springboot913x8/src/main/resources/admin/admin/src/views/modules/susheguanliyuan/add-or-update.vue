	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="宿管手机" prop="suguanshouji">
					<el-input v-model="ruleForm.suguanshouji" placeholder="宿管手机" clearable  :readonly="ro.suguanshouji"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="宿管手机" prop="suguanshouji">
					<el-input v-model="ruleForm.suguanshouji" placeholder="宿管手机" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='suguanshouji'){
							this.ruleForm.suguanshouji = obj[o];
							this.ro.suguanshouji = true;
							continue;
						}
						if(o=='zhaopian'){
