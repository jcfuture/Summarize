	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="用电量" prop="yongdianliang">
					<el-input v-model="ruleForm.yongdianliang" placeholder="用电量" clearable  :readonly="ro.yongdianliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="用电量" prop="yongdianliang">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="费用" prop="feiyong">
					<el-input v-model="feiyong" placeholder="费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.feiyong" label="费用" prop="feiyong">
...
export default {
	...
	computed: {
		...
		feiyong:{
			get: function () {
				return 1*this.ruleForm.yongdianliang*this.ruleForm.danjia
			}
		},
    ...
    // 提交
    onSubmit() {
        this.ruleForm.feiyong = this.feiyong
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dianfei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dianfeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
