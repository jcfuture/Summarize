	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="门禁卡号" prop="menjinkahao">
					<el-input v-model="ruleForm.menjinkahao" placeholder="门禁卡号" clearable  :readonly="ro.menjinkahao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="门禁卡号" prop="menjinkahao">
					<el-input v-model="ruleForm.menjinkahao" placeholder="门禁卡号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="楼层" prop="louceng">
					<el-input v-model="ruleForm.louceng" placeholder="楼层" clearable  :readonly="ro.louceng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="楼层" prop="louceng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="床位" prop="chuangwei">
					<el-input v-model="ruleForm.chuangwei" placeholder="床位" clearable  :readonly="ro.chuangwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="床位" prop="chuangwei">
					<el-input v-model="ruleForm.chuangwei" placeholder="床位" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='menjinkahao'){
							this.ruleForm.menjinkahao = obj[o];
							this.ro.menjinkahao = true;
							continue;
						}
						if(o=='sushehao'){
						...
						if(o=='chuangwei'){
							this.ruleForm.chuangwei = obj[o];
							this.ro.chuangwei = true;
							continue;
						}
						if(o=='suguanzhanghao'){
			...
			xuehaoChange () {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						if(data.data.menjinkahao){
							this.ruleForm.menjinkahao = data.data.menjinkahao
						}
					} else {
						this.$message.error(data.msg);
					}
