	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学生手机" prop="xueshengshouji">
					<el-input v-model="ruleForm.xueshengshouji" placeholder="学生手机" clearable  :readonly="ro.xueshengshouji"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="学生手机" prop="xueshengshouji">
					<el-input v-model="ruleForm.xueshengshouji" placeholder="学生手机" readonly></el-input>
				</el-form-item>
