	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="状态" prop="zhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="清扫时间" prop="qingsaoshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.qingsaoshijian" 
						type="datetime"
						:readonly="ro.qingsaoshijian"
						placeholder="清扫时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qingsaoshijian" label="清扫时间" prop="qingsaoshijian">
					<el-input v-model="ruleForm.qingsaoshijian" placeholder="清扫时间" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='qingsaoshijian'){
							this.ruleForm.qingsaoshijian = obj[o];
							this.ro.qingsaoshijian = true;
							continue;
						}
						if(o=='dengjishijian'){
