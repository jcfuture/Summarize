	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="维修需求" prop="weixiuxuqiu">
					<el-input v-model="ruleForm.weixiuxuqiu" placeholder="维修需求" clearable  :readonly="ro.weixiuxuqiu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="维修需求" prop="weixiuxuqiu">
					<el-input v-model="ruleForm.weixiuxuqiu" placeholder="维修需求" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.sheshitupian" label="设施图片" prop="sheshitupian">
					<file-upload
						tip="点击上传设施图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.sheshitupian" label="设施图片" prop="sheshitupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="申请维修时间" prop="shenqingweixiushijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.shenqingweixiushijian" 
						type="datetime"
						:readonly="ro.shenqingweixiushijian"
						placeholder="申请维修时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shenqingweixiushijian" label="申请维修时间" prop="shenqingweixiushijian">
					<el-input v-model="ruleForm.shenqingweixiushijian" placeholder="申请维修时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="维修状态" prop="weixiuzhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="维修状态" prop="weixiuzhuangtai">
					<el-input v-model="ruleForm.weixiuzhuangtai"
						placeholder="维修状态" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="设施维修原因" prop="sheshiweixiuyuanyin">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="设施维修原因"
					  v-model="ruleForm.sheshiweixiuyuanyin" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.sheshiweixiuyuanyin" label="设施维修原因" prop="sheshiweixiuyuanyin">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.sheshiweixiuyuanyin}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				weixiuxuqiu : false,
				sheshitupian : false,
				sheshiweixiuyuanyin : false,
				shenqingweixiushijian : false,
	...
	created() {
		this.ruleForm.shenqingweixiushijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='weixiuxuqiu'){
							this.ruleForm.weixiuxuqiu = obj[o];
							this.ro.weixiuxuqiu = true;
							continue;
						}
						if(o=='sheshitupian'){
						...
						if(o=='sheshiweixiuyuanyin'){
							this.ruleForm.sheshiweixiuyuanyin = obj[o];
							this.ro.sheshiweixiuyuanyin = true;
							continue;
						}
						if(o=='shenqingweixiushijian'){
							this.ruleForm.shenqingweixiushijian = obj[o];
							this.ro.shenqingweixiushijian = true;
							continue;
						}
