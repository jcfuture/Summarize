 ...
 */
@TableName("dianfei")
public class DianfeiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DianfeiEntity() {
		
	}
	
	public DianfeiEntity(T t) {
		try {
	 ...
	 * 设置：用电量
	 */
	public void setYongdianliang(Integer yongdianliang) {
		this.yongdianliang = yongdianliang;
	}
	/**
	 * 获取：用电量
	 */
	public Integer getYongdianliang() {
