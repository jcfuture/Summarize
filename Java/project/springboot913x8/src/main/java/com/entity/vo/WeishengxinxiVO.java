...
public class WeishengxinxiVO  implements Serializable {
	...
	public void setQingsaoshijian(Date qingsaoshijian) {
		this.qingsaoshijian = qingsaoshijian;
	}
	
	/**
	 * 获取：清扫时间
	 */
	public Date getQingsaoshijian() {
		return qingsaoshijian;
	}
