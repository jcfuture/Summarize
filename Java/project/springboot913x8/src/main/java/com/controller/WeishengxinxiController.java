...
public class WeishengxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,WeishengxinxiEntity weishengxinxi,
		...
		if(tableName.equals("xuesheng")) {
			weishengxinxi.setXuehao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("susheguanliyuan")) {
			weishengxinxi.setSuguanzhanghao((String)request.getSession().getAttribute("username"));
		}
