		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"94%","margin":"30px 3%"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","justifyContent":"flex-end","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(182, 179, 178, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('systemintro','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(182, 179, 178, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('systemintro','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"5px solid #CFD5F8","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#999","borderRadius":"30px","background":"rgba(255, 255, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if=" isAuth('systemintro','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"5px solid #CFD5F8","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#999","borderRadius":"30px","background":"rgba(255, 255, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if=" isAuth('systemintro','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"5px solid #CFD5F8","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#999","borderRadius":"30px","background":"rgba(255, 255, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('systemintro','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
