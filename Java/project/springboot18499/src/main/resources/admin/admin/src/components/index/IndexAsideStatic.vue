<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0 5px ","background":"#FFF","width":"170px","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","width":"145px","margin":"0 0 0 25px","overflow":"hidden","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #333;
				  				  white-space: nowrap;
				  				  background-image: url(http://codegen.caihongy.cn/20220723/cd8eafb1ed9b452682e8fc1a968c4eef.png);
				  				  position: relative;
				  		}
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						...
						background-size: cover;
						color: #fff;
						background-image: url(http://codegen.caihongy.cn/20220723/1753cccae0924c789a9559e9db68e2d2.png);
					}
