	...
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="结对人" prop="jieduiren">
					<el-input v-model="ruleForm.jieduiren" placeholder="结对人" clearable  :readonly="ro.jieduiren"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="结对人" prop="jieduiren">
					<el-input v-model="ruleForm.jieduiren" placeholder="结对人" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="结对时间" prop="jieduishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.jieduishijian" 
						type="datetime"
						:readonly="ro.jieduishijian"
						placeholder="结对时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jieduishijian" label="结对时间" prop="jieduishijian">
					<el-input v-model="ruleForm.jieduishijian" placeholder="结对时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="结对说明" prop="jieduishuoming">
					<el-input
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.jieduishuoming" label="结对说明" prop="jieduishuoming">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jieduishuoming}}</span>
				</el-form-item>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `bangfujiedui/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.bangfujieduiCrossAddOrUpdateFlag = false;
						 this.parent.search();
