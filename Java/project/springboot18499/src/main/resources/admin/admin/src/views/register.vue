<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220722/0885076d7f30408eacce61b42c646c1f.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"20px 30px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0","borderRadius":"10px","top":"0","background":"#fff","width":"500px","position":"absolute","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"20px","margin":"0 0 10px 0","color":"rgba(0, 0, 0, 1)","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600","height":"auto"}' class="title">扶孤助贫平台注册</div>
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"20px auto 15px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(165, 155, 149, 1)","display":"block","width":"80%","fontSize":"18px","height":"44px"}' type="button" class="r-btn" @click="login()">注册</button>
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(http://codegen.caihongy.cn/20220722/0885076d7f30408eacce61b42c646c1f.png);
