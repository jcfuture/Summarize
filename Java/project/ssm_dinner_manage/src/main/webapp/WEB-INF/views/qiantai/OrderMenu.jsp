...
<head>
    ...
    <script src="${APP_CONTEXT}/js/bootbox.min.js"></script>
    <style type="text/css">
        #menuView p {
            margin-top: 10px;
        }
    </style>
    <script src="${APP_CONTEXT}/js/OrderMenu.js"></script>
</head>
<body>
<div class="container">
    <div class="row">
            ...
            <form class="form-horizontal" role="form">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select id="table_id" name="tableId" class="form-control">
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div style="width: 210px;margin: 0px auto;">
                            ...
                            <input type="button" id="outOrder" value="清空全部信息" class="btn btn-danger"
    ...
    <div class="row">
        <div class="col-md-12"><h2>菜品</h2></div>
    </div>
    <div class="row">
        <div class="col-sm-3">
            <ul id="myTab" class="nav">
                <c:forEach items="${mtlist.menuTypelist}" var="mtlist">
        ...
        <div class="col-sm-9">
            <div id="myTabContent" class="tab-content">
                <c:forEach items="${mtlist.menuTypelist}" var="menus">
                    <div class="tab-pane fade" id="${menus.id}">
                        <div class="row">
                            <c:if test="${empty mtlist.menuLists}">
                                <div class="col-md-12">
                                    <h3 class="text-center">无数据</h3>
                                </div>
                            </c:if>
                            <c:if test="${!empty mtlist.menuLists}">
                                <c:forEach items="${mtlist.menuLists}" var="menulist">
                                    <c:if test="${menus.id==menulist.typeId}">
                                    <div class="col-md-3" style="margin: 10px 0px 10px 50px;">
                                        ...
                                        <div id="menuView" class="caption text-center">
                                            ...
                                            <section>
                                                <p>
                                                    <button type="button" name="jiancount"
                                                            style="background-color: transparent;border: 0px;">
                                                        <span class="glyphicon glyphicon-minus"></span>
                                                    </button>
                                                    <input type="text" value="1" name="count" readonly="readonly"
                                                           style="width: 20px;text-align: center;border: 0px;">
                                                    <button type="button" name="jiacount"
                                                            style="background-color: transparent;border: 0px;">
                                                        <span class="glyphicon glyphicon-plus"></span>
                                                    </button>
                                                </p>
                                                <p>
                                                    备注（忌口）：<input type="text" value="无" name="rank"
                                                                  style="width: 70px;border: 0px;border-bottom: 1px solid #000;">
                                                </p>
                                                <p>
