...
VkResult CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) {
    // º¯ÊýÖ¸Õë VkResult( *func)(VkInstance , const VkDebugUtilsMessengerCreateInfoEXT* , const VkAllocationCallbacks* , VkDebugUtilsMessengerEXT*) 
...
private:
    ...
    void cleanup() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
        {
            vkDestroySemaphore(device, renderFinishedSempahores[i], nullptr);
    ...
    void createLogicalDevice() {
        ...
        deviceFeatures.sampleRateShading = VK_TRUE; // enable smaple shading feature for the device
    ...
    void createSyncObjects()
    {
        ...
        renderFinishedSempahores.resize(MAX_FRAMES_IN_FLIGHT);
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
        {
            if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphores[i]) != VK_SUCCESS ||
                vkCreateSemaphore(device, &semaphoreInfo, nullptr, &renderFinishedSempahores[i]) != VK_SUCCESS ||
    ...
    void drawFrame()
    {
        ...
        VkSemaphore signalSemaphores[] = { renderFinishedSempahores[currentFrame] };
    ...
    {
        for (const auto& availiableFormat : availiableFormats)
        {
...
private:
    ...
    std::vector<VkSemaphore> renderFinishedSempahores;
